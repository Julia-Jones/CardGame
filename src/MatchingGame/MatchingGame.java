...
public class MatchingGame extends javax.swing.JFrame {
    ...
    ImageIcon h = new ImageIcon("printer.jpg");
     ImageIcon i = new ImageIcon("harddrive.jpg");////////Change picture
    ImageIcon j = new ImageIcon("keyboard.jpg");
    ImageIcon k = new ImageIcon("mice.jpg");
    ImageIcon l = new ImageIcon("monitor.jpg");//here
